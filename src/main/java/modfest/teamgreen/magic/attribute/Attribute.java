...
public abstract class Attribute implements ModifyingAttribute {
	 ...
	 */
	abstract public int activate(IWorld world, PlayerEntity caster, ModifyingAttribute modifier);
	/**
	 * @param world the world
	 ...
	 * @return an int that can be passed on to following modifiers. Typically represents some kind of strength from 0-15.
	 */
	abstract public int modify(IWorld world, int previous, PlayerEntity caster, ModifyingAttribute modifier);
